...
class VaeEncoderCausal(torch.nn.Module):
    ...
    def __init__(self, x_dim=28 * 28, z_e_dim = 10, hidden_size=256, z_c_dim=10, num_in_channels = 1, device=torch.device("cpu")):
...
class VaeDecoder(torch.nn.Module):
    ...
    def __init__(self, x_dim=28 * 28, hidden_size=256, z_dim=20, num_out_channels = 1):
